...
### 8. 🔬 雲端運算與邊緣運算應用（EfficientDet / LeNet / ResNet 合集）(個人)  
...
### 10. 🤖 自建 NLP 聊天機器人(LINE + GCP 部署)(個人)  
